...
.style('background','radial-gradient(circle, rgba(32,123,142,1) 0%, rgba(9,33,121,1) 48%, rgba(2,0,36,1) 88%)');
  ...
  choropleth_plotter(choropleth_width,choropleth_height,choropleth_svg,
    ...
    git_path+"Dataset/Average_cases/total.csv",0,[["mouseover",function (d) {console.log(d3.select(this).attr("id"));}]])
  function choropleth_plotter(map_width,map_height,map_svg,scale_domain,geojson_path,csv_path,map_state,map_funtions){
